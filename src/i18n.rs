...
pub const EN: Strings = Strings {
    ...
    pad_hint: "GAMEPAD (fixed): D-PAD/STICK move    UP hard drop    A/Y CW    B/X CCW    LB/RB hold    LT/RT zone    START pause",
...
pub const JA: Strings = Strings {
    ...
    pad_hint: "パッド(固定): 十字/スティック移動    上ハードドロップ    A/Y右回転    B/X左回転    LB/RBホールド    LT/RTゾーン    STARTポーズ",
    sec_keys: "- キー設定 -",
    sec_handling: "- 操作感 -",
    sec_audio: "- サウンド -",
    sec_display: "- 表示・言語 -",
